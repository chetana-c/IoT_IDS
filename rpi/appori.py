...
with open(f"{most_recent_file}", "rb") as f:
    requests.post(url='http://10.154.4.88:8080/activity-detected', json=json.dumps({"video": base64.b64encode(f.read()).decode("utf-8"), "timestamp": entry_time, "device_name": "detect"}))
